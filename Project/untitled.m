...
P1=[641,179;648,314;708,205;776,253;771,189;438,426;438,479;541,411;542,462;437,574;71,454;69,479;64,537;35,70;25,124];
P2=[1643,217;1680,466;1726,237;1823,302;1800,180;1732,681;1743,770;1867,627;1883,729;1769,946;1364,766;1368,804;1372,885;1465,168;1469,248];
P1x=[];
P1y=[];
P2x=[];
P2y=[];
...
point1 = double([1,1,1]);
cpoint1 = double([1,1,1]);
point2 = double([1,1,1]);
cpoint2 = double([1,1,1]);
paircount2 = 6;
uv1 = xaw(:,1:2);
uv2 = xan(:,1:2);
...
for i = 1:(paircount + paircount2 +paircount2)
...
hold on;
axis equal;
plot3(debugdisp(:,1), debugdisp(:,2),debugdisp(:,3));
plot3(final_result(:,1), final_result(:,2),final_result(:,3));
hold on;
plot3(final_result(1:paircount,1), final_result(1:paircount,2),final_result(1:paircount,3));
%figure;
%ImageMatrix = imread('funmat_wei.jpg');
%imshow(ImageMatrix);
%hold("on");
