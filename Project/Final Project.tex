...
In order to get the correspondence between the two videos, we will set up a timer that can be seen in both the video cameras.

When the movement curve is successfully reconstructed, we will try to track the movement of basketball shot in different ways, i.e. with or without spin, and to compare the differences among the curves.
